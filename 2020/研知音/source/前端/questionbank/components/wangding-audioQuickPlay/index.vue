<template>
	<view class="audo-video">
		<video id="myVideo" :src="url" class="hidden" @timeupdate="timeupdate" ref="video" @loadedmetadata="loadedmetadata" hidden></video>
...
<script>
	export default {
		...
		created() {
			/* var audioManage= wx.getBackgroundAudioManager();
			audioManage.src= */
			 this.videoContext = wx.getBackgroundAudioManager();
