		...
		<view class="content" @tab="hideList" @click="hideList">
			...
			<view class="btn-box">
				<view class="flex-item">
					...
					<!-- <text class="cuIcon-favorfill lg text-red" v-if="audiolist[curPlayIndex].favor==true"></text>
					<text class="cuIcon-favor lg text-white" v-if="audiolist[curPlayIndex].favor==false"></text>
				 --></view>
				<view class="flex-item iconfont" @click="feedBack">&#xe628;</view>
				<!-- <view class="flex-item iconfont">&#xe60e;</view> -->
				<!-- <text class="flex-item cuIcon-write lg text-white"></text> -->
			</view>
		...
		methods: {
			...
			initPlay(id,index) {
				if(index){
					...
					const surl = "https://www.lztk.xyz/knowledgeaudio/1.mp3";
					...
					const singer = "研知音";
					var picUrl = "http://p3.music.126.net/uyMO9Fx8a_d4a93xRnuRLA==/109951163871163527.jpg";
					this.lybot = '';
					this.lycur = '';
					this.lytop = '';
					this.song = {
