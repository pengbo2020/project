...
<script>
	...
	export default {
		...
		methods: {
			...
			{
				var that=this;
				that.audioManager=that.$au_player;
				that.audioManager.autoplay=false;
				...
				Vue.prototype.cusPlay = that.onPlayFn
				Vue.prototype.cusTimeUpdate = that.onTimeUpdateFn
				Vue.prototype.cusEnded = that.onEndedFn
